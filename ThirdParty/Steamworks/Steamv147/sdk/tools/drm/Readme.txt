...
2.	Take the steam guard code from email and paste it in place of 밹ode?in the cfg file after 밶uth:?
3.	Run the DRM tool
4.	Once you뭭e successfully signed in and drm뭙d an exe, remove the auth line from the cfg file
